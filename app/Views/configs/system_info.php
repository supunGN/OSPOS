...
clearstatcache();
if (is_writable($logs) && ! $is_windows && substr(decoct(fileperms($logs)), -4) !== 750) {
...
if (is_writable($uploads) && ! $is_windows && substr(decoct(fileperms($uploads)), -4) !== 750) {
    echo ' | <span style="color: red;">Vulnerable or Incorrect Permissions &#x2717</span>';
} else {
    echo ' |  <span style="color: green;">Security Check Passed &#x2713 </span>';
}
...
if (! $is_windows && substr(decoct(fileperms($images)), -4) !== 750) {
    echo ' | <span style="color: red;">Vulnerable or Incorrect Permissions &#x2717</span>';
} else {
    echo ' | <span style="color: green;">Security Check Passed &#x2713 </span>';
}
...
if (! $is_windows && ! ((substr(decoct(fileperms($importCustomers)), -4) === 640) || (substr(decoct(fileperms($importCustomers)), -4) === 660))) {
    echo ' | <span style="color: red;">Vulnerable or Incorrect Permissions &#x2717</span>';
} else {
    echo ' | <span style="color: green;">Security Check Passed &#x2713 </span>';
}
...
?>
                <br>
                <?php
$logs_ok            = $is_windows || (substr(decoct(fileperms($logs)), -4) === 750);
$uploads_ok         = $is_windows || (substr(decoct(fileperms($uploads)), -4) === 750);
$images_ok          = $is_windows || (substr(decoct(fileperms($images)), -4) === 750);
$importCustomers_ok = $is_windows || (substr(decoct(fileperms($importCustomers)), -4) === 640) || (substr(decoct(fileperms($importCustomers)), -4) === 660);

if (! ($logs_ok && $uploads_ok && $images_ok && $importCustomers_ok)) {
